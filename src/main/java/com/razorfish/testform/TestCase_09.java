...
/**
 Negative Test - correct first name, wrong last name (with 21 characters) and correct phone number.
 *
 */
...
public class TestCase_09   
{
    public static void main( String[] args )
    {
    	 ...
    	 driver.findElement(By.xpath("/html/body/div/form/input[2]")).sendKeys("GuoGuoGuoGuoGuoGuoGuo");
