...
/**
 * 
Negative test -   wrong first name (no first name entered), correct last name and correct phone number
 *
 */
public class TestCase_04   
{
    public static void main( String[] args )
    {
    	System.setProperty ("webdriver.chrome.driver","C:\\Program Files\\chromedriver.exe");
    	 ...
    	 driver.findElement(By.xpath("/html/body/div/form/input[1]")).sendKeys("");
