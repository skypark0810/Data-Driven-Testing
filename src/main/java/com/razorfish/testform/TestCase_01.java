...
/**
Positive test - for correct first name (with 10 characters), correct last name(with 10 characters) and correct phone number
 *
 */
...
public class TestCase_01   
{
    public static void main( String[] args )
    {
    	System.setProperty ("webdriver.chrome.driver","C:\\Program Files\\chromedriver.exe");
    	 ...
    	 driver.findElement(By.xpath("/html/body/div/form/input[1]")).sendKeys("Lepingabcde");
    	 driver.findElement(By.xpath("/html/body/div/form/input[2]")).sendKeys("Guoabcdefg");
