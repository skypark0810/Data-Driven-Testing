...
/**
POsitive test - for correct first name (only 1 character), correct last name and correct phone number
 *
 */
...
public class TestCase_02   
{
    public static void main( String[] args )
    {
    	System.setProperty ("webdriver.chrome.driver","C:\\Program Files\\chromedriver.exe");
    	 ...
    	 driver.findElement(By.xpath("/html/body/div/form/input[1]")).sendKeys("L");
